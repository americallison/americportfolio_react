...
export default function Projects() {
    ...
    <div class="rounded overflow-hidden shadow-lg">
      <img class="w-full hover:scale-105 transition duration-300 ease-in-out" src={pic} alt="Mountain" />
      <div class="px-6 py-4">
    ...
    {/* <!--Card 2--> */}
    <div class="rounded overflow-hidden shadow-lg">
      <img class="w-full hover:scale-105 transition duration-300 ease-in-out" src={pic1} alt="River" />
      <div class="px-6 py-4">
