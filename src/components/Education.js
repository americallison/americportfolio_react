...
export default function Education() {
  return (
    <>
      ...
      <div id="education" className="bg-[#003049] h-auto my-6 py-8 rounded-lg border-4">
      <div className="flex justify-center">
        <h3 className="border-4 w-30 bg-amber-900 text-stone-200 border-dashed px-4 py-4">Education</h3>
      </div>
