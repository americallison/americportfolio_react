  ...
  <div id="work" className="bg-[#213502] h-auto my-6 py-8 rounded-lg border-4">
  <div className="flex justify-center">
    <h3 className="border-4 w-20 bg-teal-900 text-white border-dashed px-4 py-4">Work</h3>
  </div>

  <details className="px-6 py-4">
    <summary className="font-bold text-2xl text-stone-100">Institute of Basic Technology (February 2022 - present)</summary>
    <p>I presently teach Computer Literacy, Web Design and Python Programming. My teaching methodology is 
      mainly centered around projects. I believe project based learning is the way to go in enabling 
      students solve real world problems. Practicality is essential in my sphere.
    </p>
  </details>
  ...
  <details className="px-6 py-4">
    <summary className="font-bold text-2xl text-stone-100">College of Agriculture and Sustainable Development (Cuttington University) - (2015 - 2016)</summary>
