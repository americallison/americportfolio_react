...
export default function Hobbies() {
  return (
    <>
      ...
      <div id="hobbie" className="bg-[#20639b] h-auto my-6 py-8 rounded-lg border-4">
      <div className="flex justify-center">
        <h3 className="border-4 w-30 bg-sky-900 text-white border-dashed px-4 py-4">Hobbies</h3>
      </div>
    
      <details className="px-6 py-4">
        <summary className="font-bold text-2xl text-stone-100">Reading</summary>
        <p>I love to read books on a variety of subjects ranging from programming, business, intelligence, etc.
        </p>
      </details>
    
      <details className="px-6 py-4">
        <summary className="font-bold text-2xl text-stone-100">Playing Sports</summary>
        <p>I play soccer, basketball, lawn tennis and volleyball.
        </p>
      </details>

      <details className="px-6 py-4">
        <summary className="font-bold text-2xl text-stone-100">Exercise</summary>
