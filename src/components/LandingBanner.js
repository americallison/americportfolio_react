...
<div className="relative min-h-screen">
  <div className="md:flex block">
    ...
    {/* Image Banner */}
    <div
      className="md:w-6/12 w-full shadow-lg rounded-sm animate-fade-in-image delay-3000"
      style={{
  ...
  <div className="md:flex block mt-3 animate-fade-in-image delay-3000">
