...
<div className="relative min-h-screen">
  <div className="md:flex block">
    ...
    <div className="md:w-6/12 w-full p-5 bg-[#173F5F] bg-opacity-90 flex flex-col justify-center">
      ...
      <small className="text-xl text-white md:ml-5 sm:m-2 md:mt-1 mt-1">
        Aspiring Software Engineer Web Developer, Teacher &amp; Data Analyst
      </small>
      <p className="text-lg m-2 md:mb-3 md:mb-2 md:pt-3 md:ml-5 md:mt-3 text-[#F6D55C]">
  ...
  <div className="ml-5">
    <p className="text-white ml-5 mt-4 text-xl">Check me out on:</p>
  </div>
