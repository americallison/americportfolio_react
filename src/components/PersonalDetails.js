      ...
      <div id="content" className="prose lg:prose-xl px-2">
        ...
        <div className="p-6 max-w-full mx-auto">
            <ul className="flex justify-center items-center gap-4">
              <li className={`border border-zinc-500 rounded-lg p-4 ${isActive.active && isActive.name === "education" && 'bg-[#f2e7d5] '}`}>
               <a href="#education" onClick={handleActive} id="education" className="font-roboto font-bold text-xl">Education</a>
              </li>
              <li className={`border border-zinc-500 rounded-lg p-4 ${isActive.active && isActive.name === "work" && 'bg-[#f2e7d5] '}`}>
              <a href="#work" onClick={handleActive}  id="work" 
              className="font-roboto font-bold text-xl">Work</a>
              </li>
              <li className={`border border-zinc-500 rounded-lg p-4 ${isActive.active && isActive.name === "hobbies" && 'bg-[#f2e7d5] '}`}>
